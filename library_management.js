...
const book6 = new Book("The Accidental Superpower", "Author: Peter Zeihan", "ISBN: 7865");
const book7 = new Book("The Absent Superpower", "Author: Peter Zeihan", "ISBN: 7825");
...
nonFictionSection.addBook(book6);
nonFictionSection.addBook(book7);
...
console.log(nonFictionSection.calculateTotalBooksAvailable());
...
const VIP_patron1 = new VIPPatron("Luke");
...
VIP_patron1.borrowBook(book7);
VIP_patron1.returnBook(book7);
VIP_patron1.borrowBook(book6);
console.log(`Non Fiction Books Available: ${nonFictionSection.calculateTotalBooksAvailable()}`);
console.log(`Fiction Books Available: ${fictionSection.calculateTotalBooksAvailable()}`);
